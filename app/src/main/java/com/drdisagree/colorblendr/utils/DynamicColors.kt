...
object DynamicColors {
    val ALL_DYNAMIC_COLORS_MAPPED: MutableList<Pair<String, Any>> = ArrayList()
    val FIXED_COLORS_MAPPED: MutableList<Pair<String, Pair<Int, Int>>> = ArrayList()
    val M3_REF_PALETTE: MutableList<Pair<String, Pair<Int, Pair<Int, Int>>>> = ArrayList()
     ...
     */
    init {
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "primary_container",
                Pair.create(0, Pair.create(3, 9))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "on_primary_container",
                Pair.create(0, Pair.create(11, 3))
            )
        )
        ...
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "secondary_container",
                Pair.create(1, Pair.create(3, 9))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "on_secondary_container",
                Pair.create(1, Pair.create(11, 3))
            )
        )
        ...
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "on_secondary",
                Pair.create(1, Pair.create(0, 10))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "tertiary_container",
                Pair.create(2, Pair.create(3, 9))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "on_tertiary_container",
                Pair.create(2, Pair.create(11, 3))
            )
        )
        ...
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "on_tertiary",
                Pair.create(2, Pair.create(0, 10))
            )
        )
        ...
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "on_background",
                Pair.create(3, Pair.create(11, 1))
            )
        )
        ...
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                ...
                Pair.create(3, Pair.create(2, 10))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "surface_container_lowest",
                Pair.create(3, Pair.create(1, 11))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
        ...
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                ...
                Pair.create(
                    3,
                    Pair.create(
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) 1 else 2,
                        10
                    )
                )
            )
        ...
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                ...
                Pair.create(3, Pair.create(3, 9))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "surface_bright",
                Pair.create(3, Pair.create(1, 10))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "surface_dim",
                Pair.create(3, Pair.create(2, 11))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "surface_variant",
                Pair.create(4, Pair.create(2, 10))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "on_surface_variant",
                Pair.create(4, Pair.create(10, 2))
            )
        )
...
//        ALL_DYNAMIC_COLORS_MAPPED.add(Pair.create("text_hint_inverse", ));
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                ...
                Pair.create(0, Pair.create(4, 8))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "palette_key_color_secondary",
                Pair.create(1, Pair.create(4, 8))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "palette_key_color_tertiary",
                Pair.create(2, Pair.create(4, 8))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "palette_key_color_neutral",
                Pair.create(3, Pair.create(4, 8))
            )
        )
        ALL_DYNAMIC_COLORS_MAPPED.add(
            Pair.create(
                "palette_key_color_neutral_variant",
                Pair.create(4, Pair.create(4, 8))
            )
        )
        ...
        M3_REF_PALETTE.add(
            Pair.create(
                ...
                Pair.create(-60, Pair.create(3, 11))
            )
        )
        M3_REF_PALETTE.add(
            Pair.create(
                "m3_ref_palette_dynamic_neutral6",
                Pair.create(-40, Pair.create(3, 11))
            )
        )
        M3_REF_PALETTE.add(
            Pair.create(
                "m3_ref_palette_dynamic_neutral12",
                Pair.create(20, Pair.create(3, 10))
            )
        )
        M3_REF_PALETTE.add(
            Pair.create(
                "m3_ref_palette_dynamic_neutral17",
                Pair.create(70, Pair.create(3, 10))
            )
        )
        M3_REF_PALETTE.add(
            Pair.create(
