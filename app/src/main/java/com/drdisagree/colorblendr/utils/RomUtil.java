...
/**
 * Source: <a href="https://github.com/Blankj/AndroidUtilCode/blob/master/lib/utilcode/src/main/java/com/blankj/utilcode/util/RomUtils.java">...</a>
 */
...
public class RomUtil {
    ...
    private static String getSystemPropertyByShell(final String propName) {
        return Shell.cmd("getprop " + propName).exec().getOut().get(0);
    }
