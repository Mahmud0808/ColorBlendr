...
import static com.drdisagree.colorblendr.utils.monet.dynamiccolor.DynamicScheme.Platform.PHONE;
import static com.drdisagree.colorblendr.utils.monet.dynamiccolor.DynamicScheme.Platform.WATCH;
import static com.drdisagree.colorblendr.utils.monet.dynamiccolor.ToneDeltaPair.DeltaConstraint.EXACT;
import static com.drdisagree.colorblendr.utils.monet.dynamiccolor.ToneDeltaPair.DeltaConstraint.FARTHER;
import static com.drdisagree.colorblendr.utils.monet.dynamiccolor.TonePolarity.DARKER;
import static com.drdisagree.colorblendr.utils.monet.dynamiccolor.TonePolarity.RELATIVE_LIGHTER;
import static com.drdisagree.colorblendr.utils.monet.dynamiccolor.Variant.EXPRESSIVE;
import static com.drdisagree.colorblendr.utils.monet.dynamiccolor.Variant.NEUTRAL;
import static com.drdisagree.colorblendr.utils.monet.dynamiccolor.Variant.TONAL_SPOT;
import static com.drdisagree.colorblendr.utils.monet.dynamiccolor.Variant.VIBRANT;
...
final class ColorSpec2025 extends ColorSpec2021 {
    ...
    public TonalPalette getPrimaryPalette(
        ...
        return switch (variant) {
            ...
            default ->
                    super.getPrimaryPalette(variant, sourceColorHct, isDark, platform, contrastLevel);
        };
    }
    ...
    public TonalPalette getTertiaryPalette(
        ...
        return switch (variant) {
            ...
            case VIBRANT -> TonalPalette.fromHueAndChroma(
                    ...
                    56);
            default ->
                    super.getTertiaryPalette(variant, sourceColorHct, isDark, platform, contrastLevel);
        };
    }
    ...
    public TonalPalette getNeutralPalette(
        ...
        return switch (variant) {
            ...
            default ->
                    super.getNeutralPalette(variant, sourceColorHct, isDark, platform, contrastLevel);
        };
    }
    ...
    public Optional<TonalPalette> getErrorPalette(
        ...
        return switch (variant) {
            ...
            default ->
                    super.getErrorPalette(variant, sourceColorHct, isDark, platform, contrastLevel);
        };
    }
    ...
    private static double getExpressiveNeutralChroma(
            Hct sourceColorHct, boolean isDark, DynamicScheme.Platform platform) {
